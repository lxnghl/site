...
const DateNavigator = ({currentDate, formatDate, setCurrentDate}) => {
    ...
    const prettyDate = new Date(currentDate).toLocaleDateString('ro-RO', {
        weekday: 'long',
        day: '2-digit',
        month: 'short',
        year: 'numeric',
    ...
    return (
        <div className="flex justify-between items-center mb-6">
            ...
            <h2 className="text-lg md:text-xl font-semibold truncate text-black"
                onClick={() => window.location.reload()}>{prettyDate}</h2>
            <button
